...
function showPosition(position) {
    ...
    return (
        ...
        <div className="font-sans antialiased text-gray-900 leading-normal tracking-wider bg-cover" style={{backgroundImage:"url('https://source.unsplash.com/1L71sPT5XKc')"}}>
          ...
          <div className="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto pt-32 lg:my-0">
            
            <div id="profile" className="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-6 lg:mx-0">
            
        
                <div className="p-4 md:p-12 text-center mt-10 lg:text-left">
                    <div className="block lg:hidden rounded-full shadow-xl mx-auto -mt-16 h-32 w-32 bg-cover bg-center" style={{backgroundImage:`url(${ProfileImage})`}}>
                       
                    </div>
                    <input type='text' className="text-3xl font-bold pt-8 lg:pt-0 focus:outline-none text-center" placeholder='Your Name'/>
                    ...
                    <p className="pt-4 text-base font-bold flex items-center justify-center lg:justify-start">
                        <svg className="h-4 fill-current text-green-700 pr-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M9 12H1v6a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-6h-8v2H9v-2zm0-1H0V5c0-1.1.9-2 2-2h4V2a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v1h4a2 2 0 0 1 2 2v6h-9V9H9v2zm3-8V2H8v1h4z"/></svg>
                         <label for='selector'>What you do? </label>
                    ...
                    <textarea className="mt-5 pt-8 text-sm w-full text-center focus:outline-none lg:w-full" >Write something about your coding skill</textarea>
        
                    <div className="pt-12 pb-8">
                        <button className="bg-red-300 hover:bg-red-500 text-white font-bold py-2 px-4 rounded-full">
                          Subscribe
                        </button> 
                    </div>
               ...
               <div className="w-full lg:w-2/5 ">
                <img src={ProfileImage} alt='imageofsubscribe' className="rounded-none lg:rounded-lg shadow-2xl hidden lg:block ml-20"/>
