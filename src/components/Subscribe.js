...
function showPosition(position) {
    ...
    return (
        ...
        <div className="font-sans antialiased text-gray-900 leading-normal tracking-wider bg-cover" style={{backgroundImage:"url('https://source.unsplash.com/1L71sPT5XKc')"}}>
          ...
          <div className="max-w-4xl flex flex-col lg:flex-row items-center lg:h-screen  mx-auto  lg:my-0 ">
          {
              position.latitude?(
            ...
            <div id="profile" className="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-4 lg:mx-0">
            
        
                <div className="p-4 md:p-12 text-center mt-10 lg:text-left ">
                    
                    <input type='email' className="text-3xl font-bold pt-8 lg:pt-0 focus:outline-none text-left pl-24 md:pl-0 md:text-center " placeholder='Your Email'/>
                    ...
                    <p className="pt-4 text-base font-bold flex items-center justify-center lg:justify-start">
                        <svg className="h-4 fill-current text-green-700 pr-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M9 12H1v6a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-6h-8v2H9v-2zm0-1H0V5c0-1.1.9-2 2-2h4V2a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v1h4a2 2 0 0 1 2 2v6h-9V9H9v2zm3-8V2H8v1h4z"/></svg>
                         <label htmlFor='selector'>What you do? </label>
                         <select id='selector' className='ml-10'>
                    ...
                    Your Location - <span id='geolocation'></span></p>
                    <textarea className="mt-5 pt-8 text-sm w-full text-center focus:outline-none lg:w-full border-2" defaultValue='Write something about your coding skill' ></textarea>
        
                    <div className="pt-12 pb-8">
                        <button className="bg-red-300 hover:bg-red-500 text-white font-bold py-2 px-4 rounded-full" type='submit'>
                          Subscribe
                        </button> 
                    </div>
            ...
            {
              position.latitude?(
                <div className="w-full hidden lg:w-2/5 lg:inline-flex ml-10  ">
               <Map locationData={position}/>
                </div>
              ):(null)
            }
