        ...
        <div className="font-sans antialiased text-gray-900 leading-normal tracking-wider bg-cover" style={{backgroundImage:"url('https://source.unsplash.com/1L71sPT5XKc')"}}>
          ...
          <div className="max-w-4xl flex flex-col lg:flex-row items-center lg:h-screen  mx-auto  lg:my-0 ">
          {
            ...
            <div id="profile" className="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-4 lg:mx-0">
                ...
                <div className="p-4 md:p-12 text-center mt-20 lg:text-left ">
                    
                    <input type='text' className="text-3xl font-bold pt-8 lg:pt-0 focus:outline-none text-left pl-24 md:pl-0 md:text-center " placeholder='Your Name'/>
                    ...
                    <textarea className="mt-5 pt-8 text-sm w-full text-center focus:outline-none lg:w-full" defaultValue='Write something about your coding skill' ></textarea>
